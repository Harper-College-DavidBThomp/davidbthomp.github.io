 ...
 function getValues() {
     ...
     inputs.apa =  document.getElementById("bibliography").innerHTML= (`${inputs.lname}, ${inputs.fname.substring(0, 1).toUpperCase()}. (${inputs.year.getFullYear()}) ${inputs.title}. ${inputs.city}, ${inputs.state.toUpperCase()}: ${inputs.pub}.`);
